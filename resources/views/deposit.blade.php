...
<div class=" mt-4 flex justify-center">
    ...
    <form action="{{ route('deposit') }}" method="post" id="">
        @csrf
      <label for="amount">Amount</label>
      <input type="number" id="amount" name="amount" class="bg-gray-100 border-2 w-full p-4 rounded-lg "><br><br>

      <label for="recipient">Choose an account</label><br><br>

      <label for="sav_accs">Savings</label>
        <input type="radio" name="sav_accs" id="sav_accs">

        <label for="chq_accs">Chequing</label>
        <input type="radio" name="chq_accs" id="chq_accs">

        <label for="inv_accs">Investment</label>
        <input type="radio" name="inv_accs" id="inv_accs">
