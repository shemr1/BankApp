...
<div class=" mt-4 flex justify-center">
    <div class="w-3/12 bg-white p-6 rounded-lg ml-2">
        <h1>Input amount to be transferred</h1>
    
    <form action="{{ route('transfer') }}" method="post" id="">
        @csrf
      <label for="amount">Amount</label>
      <input type="number" id="amount" name="amount" class="bg-gray-100 border-2 w-full p-4 rounded-lg "><br><br>

      <label for="recipient">Choose an account to transfer from</label><br><br>
      ...
      <br>
      <br>
      <label for="recipient">Choose an account to transfer to</label><br><br>
      ...
      <br>
      <br>
      <input type="submit" value="Submit" class="flex items-center justify-center ml-6  bg-indigo-700 border border-transparent text-base font-medium rounded-md text-white">
    </form>
